...
namespace Rugal.PartialViewRender.TagBase
{
    public abstract class PvNodeTagBase : TagHelper
    {
        ...
        public PvNodeTagBase(IServiceProvider _Provider)
        {
            Provider = _Provider;
            LayoutStore = Provider.GetRequiredService<PvLayoutStore>();
    ...
    public abstract class PvTagBase<TPvs> : PvNodeTagBase where TPvs : Enum
    {
        ...
        public PvTagBase(IServiceProvider _Provider) : base(_Provider)
        {
            Render = Provider.GetRequiredService<PvRender<TPvs>>();
        }
